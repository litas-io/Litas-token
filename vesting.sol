...
contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    modifier onlyIfVestingScheduleNotRevoked(bytes32 vestingScheduleId) {
        require(!vestingSchedules[vestingScheduleId].revoked, "TokenVesting: vesting schedule is revoked");
        _;
    }
    ...
    function createVestingSchedule(
        ...
        require(getWithdrawableAmount() >= _amount, "TokenVesting: insufficient tokens");
